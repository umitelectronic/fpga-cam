...
GPMC_SYSCONFIG/4));
    ...
    HWREG(gpmc_reg_pointer + GPMC_CONFIG4(csNum)/4) = (0x0 |
            (3 << GPMC_CONFIG4_0_OEONTIME_SHIFT) |	//OE_ASSERT
	    (7 << GPMC_CONFIG4_0_OEOFFTIME_SHIFT) |	//OE_DEASSERT
	    (3 << GPMC_CONFIG4_0_WEONTIME_SHIFT)| //WE_ASSERT
	    (7 << GPMC_CONFIG4_0_WEOFFTIME_SHIFT)); //WE_DEASSERT
    ...
    HWREG(gpmc_reg_pointer + GPMC_CONFIG6(csNum)/4) = (0x0 |
	    ...
	    (3 << GPMC_CONFIG6_0_WRDATAONADMUXBUS_SHIFT)| //WR_DATA_ON_ADMUX
